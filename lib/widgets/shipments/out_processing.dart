...
class OutProcessing extends StatelessWidget {
  const OutProcessing({
    Key? key,
    required Stream<QuerySnapshot<Map<String, dynamic>>> processingStream,
  }) : _processingStream = processingStream, super(key: key);

  final Stream<QuerySnapshot<Map<String, dynamic>>> _processingStream;
